...
const Historico: React.FC = () => {
    ...
    const historicoEntries = [
        ...
        },
        {
            ...
            hora: '14:00',
            tipoServico: 'Evento Privado',
            endereco: 'Rua Pioneiro Geraldo M. da Silva, 450 - Zona 08 - Maringá - PR',
        ...
        },
        {
            ...
            hora: '18:00',
            tipoServico: 'Atendimento a domicilio',
            endereco: 'Rua Pioneiro Guarino Augusto Basilio, 200 - Parque Industrial - Maringá - PR',
            ...
            <aside className="historico-sidebar">
                <div className="sidebar-content">
                    ...
                    <nav className="sidebar-nav">
                        ...
                        <a href="#" className="nav-item active">Históricos</a>
                    </nav>
                </div>
            </aside>
                        ...
                        {historicoEntries.map((entry, index) => (
                            <div key={index} className="historico-entry">
                                <div className="entry-header">
                                    <span className="entry-value">R$ {entry.valor.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
                                    <span className="entry-date-time">{entry.data} - {entry.hora}</span>
                                </div>
                                <div className="entry-details">
                                    <p className="entry-service">{entry.tipoServico}: {entry.endereco}</p>
                                    <p className="entry-client">{entry.clienteNome} - Contato: {entry.contato}</p>
                                </div>
                            </div>
                        ))}
                    </div>
